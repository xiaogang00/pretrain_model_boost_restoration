...
def create_dataset(dataset_opt):
    ...
    elif mode == 'video_samesize_lol22':
        from data.dataset_LOLv2_real2 import VideoSameSizeDataset as D
    elif mode == 'video_samesize_lol3':
        from data.dataset_LOLv2_synthetic import VideoSameSizeDataset as D
    elif mode == 'video_samesize_lol32':
        from data.dataset_LOLv2_synthetic2 import VideoSameSizeDataset as D
