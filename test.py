...
def main():
    ...
    save_folder = '/home/snr-enhancement/results/{}'.format(opt['name'])
        ...
        for val_data in val_loader:
            ...
            if save_imgs:
                try:
                    ...
                    tag = val_data['folder'][0]
                    if '.npy' in os.path.basename(val_data['path'][0][0]):
                        path_save_this=os.path.basename(val_data['path'][0][0]).split('.npy')[0]
                    elif '.jpg' in os.path.basename(val_data['path'][0][0]):
                        path_save_this=os.path.basename(val_data['path'][0][0]).split('.jpg')[0]
                    elif '.png' in os.path.basename(val_data['path'][0][0]):
                        path_save_this=os.path.basename(val_data['path'][0][0]).split('.png')[0]
                        
                    tag=path_save_this
                    print(osp.join(output_folder, '{}.png'.format(tag)), tag, path_save_this,'aaaaaaa')
